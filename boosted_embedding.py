...
class BoostedFactorization:
    ...
    def __init__(self, residuals, args):
        ...
        self.edges = list(zip(self.index_1, self.index_2))
    ...
    def sampler(self,index):
        ...
        to_pick_from = {i: float(row_weights[0,i])**2/sums for i in range(0,row_weights.shape[1])}
    ...
    def save_embedding(self):
        ...
        feature_names = ["x_"+str(dim) for dim in range(self.args.iterations*self.args.dimensions)]
